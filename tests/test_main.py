...
def test_main_01(mocker, arg):
    ...
    mocker.patch("guided_fuzzing_daemon.main.aflfuzz_main")
...
@pytest.mark.parametrize("mode", ("libfuzzer", "aflfuzz", "nyx"))
def test_main_03(mode, mocker):
    ...
    mocker.patch("guided_fuzzing_daemon.main.S3Manager")
    mocks = {
        "aflfuzz": mocker.patch("guided_fuzzing_daemon.main.aflfuzz_main"),
